...
// ref to:
// https://github.com/vllm-project/vllm/blob/main/csrc/cutlass_extensions/epilogue/scaled_mm_epilogues_c3x.hpp
...
// Custom epilogues for fusing channel scales, token scales, bias, and
// activation zero-points onto a GEMM operation using CUTLASS 3.x API.
// Targets NVIDIA GPUs with sm90a (Hopper) or later.
//
// Each epilogue must provide:
// - EVTCompute: a public type of Sm90EVT
// - prepare_args(): static function returning EVTCompute::Arguments
