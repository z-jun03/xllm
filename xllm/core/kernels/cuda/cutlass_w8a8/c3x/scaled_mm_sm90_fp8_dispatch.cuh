...
// Gemm kernel configurations for SM90 (fp8) based on problem shape.
...
struct sm90_fp8_config_default {
  ...
  using Cutlass3xGemm =
      conditional_t<EnableBias,
                    cutlass_3x_gemm_sm90_fp8<InType,
                                             OutType,
...
void cutlass_gemm_caller_sm90_fp8(torch::Tensor& out,
...
inline void cutlass_gemm_sm90_fp8_dispatch(torch::Tensor& out,
  ...
  using Cutlass3xGemmDefault =
      typename sm90_fp8_config_default<InType, OutType, EnableBias>::
          Cutlass3xGemm;
  using Cutlass3xGemmM8192_K6144 =
      typename sm90_fp8_config_M8192_K6144<InType, OutType, EnableBias>::
          Cutlass3xGemm;
  using Cutlass3xGemmM128 =
      typename sm90_fp8_config_M128<InType, OutType, EnableBias>::Cutlass3xGemm;

  using Cutlass3xGemmM64_N1280 =
      typename sm90_fp8_config_M64_N1280<InType, OutType, EnableBias>::
          Cutlass3xGemm;
  using Cutlass3xGemmM64_N8192 =
      typename sm90_fp8_config_M64_N8192<InType, OutType, EnableBias>::
          Cutlass3xGemm;
  using Cutlass3xGemmM16_N1280 =
      typename sm90_fp8_config_M16_N1280<InType, OutType, EnableBias>::
          Cutlass3xGemm;
  using Cutlass3xGemmM16_N8192 =
      typename sm90_fp8_config_M16_N8192<InType, OutType, EnableBias>::
          Cutlass3xGemm;
