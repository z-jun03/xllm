...
from xllm.python.kernels_npu.tilelang import (
    pack_qkv_destination_major as kernel_impl,
)
from xllm.python.kernels_npu.tilelang import (
    utils as tilelang_utils,
)
from xllm.python.kernels_npu.tilelang.pack_qkv_destination_major import (
    DEFAULT_ASCEND_PASS_CONFIGS,
    SUPPORTED_DTYPES,
    build_pack_qkv_destination_major_kernel,
    detect_vec_core_num,
)
...
@register_kernel
class PackQkvDestinationMajorKernel(TilelangKernel):
    ...
    def generate_source(dtype: str) -> str:
        ...
        tilelang_kernel = build_pack_qkv_destination_major_kernel(
            dtype=dtype,
