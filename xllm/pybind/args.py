...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--block_size', type=int, default=16, help='Number of slots per kv cache block. Default is 16.')
        ...
        self.parser.add_argument('--max_tokens_per_batch', type=int, default=2147483647, help='Max number of tokens per batch.')
        self.parser.add_argument('--max_seqs_per_batch', type=int, default=256, help='Max number of sequences per batch.')
        self.parser.add_argument('--max_tokens_per_chunk_for_prefill', type=int, default=2048, help='Max number of tokens per chunk for request in prefill stage.')
